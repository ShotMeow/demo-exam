...
<html lang="ru">
    ...
    <body>
        <header class="navbar-expand bg-body-tertiary">
            <div class="container d-flex align-items-center justify-content-between gap-2 flex-wrap pb-2">
                <a href="/">
                ...
                <nav class="navbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/where-are">Где нас найти</a></li>
                    </ul>
                </nav>
                <div>
                    @guest()
